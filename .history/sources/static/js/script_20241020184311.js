...
// Nút để hiển thị sidebar và tìm kiếm
...
// Sự kiện cho menu button
menu_btn.onclick = function(){
  sidebar.classList.toggle("active");
}

// Sự kiện cho search button
search_btn.onclick = function(){
  sidebar.classList.toggle("active");
}

// Sự kiện cho nút chọn tệp
button.onclick = () => {
  input.click();
};

// Chức năng hiển thị loader
function loading_on() {
...
// Sự kiện khi tệp rời khỏi vùng kéo thả
...
// Hàm để kiểm tra tệp có hợp lệ hay không
...
// Chuyển đổi mảng đối tượng thành CSV
...
// Hàm để tải dữ liệu đã trích xuất
